...
class PageJdIpanemaWidget extends StatefulWidget {
  const PageJdIpanemaWidget({Key key}) : super(key: key);

  @override
  _PageJdIpanemaWidgetState createState() => _PageJdIpanemaWidgetState();
}

class _PageJdIpanemaWidgetState extends State<PageJdIpanemaWidget> {
